...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("skillopt", "Optimize a skill document for a frozen agent (SkillOpt)",
               "Tools & Skills", cli_only=True, args_hint="optimize <skill> --tasks <file>",
    ...
    CommandDef("insights", "Show usage insights and analytics", "Info",
               args_hint="[days]"),
    CommandDef("report", "Generate Hermes Turbo reports (savings, perf, etc.)", "Info",
               cli_only=True, args_hint="<savings>", subcommands=("savings",)),
    CommandDef("migrate-from-openclaw",
               "Migrate from OpenClaw to Hermes Turbo (optionally with benchmark)",
               "Configuration", cli_only=True,
               args_hint="[--benchmark]"),
