...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            "agent_name": "Hermes Turbo Agent",
            "welcome": "Welcome to Hermes Turbo Agent — a modified, faster Hermes. Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Hermes Turbo ",
            "prompt_symbol": "❯",
