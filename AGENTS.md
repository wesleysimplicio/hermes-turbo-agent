...
> performance + project-on-ramp customizations: HERMES_TURBO_HOME, Rust `hermes_fast`
...
state in `$HERMES_TURBO_HOME/mapped_projects.json`. Re-running on a fresh project is a
no-op.
