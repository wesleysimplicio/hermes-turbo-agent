...
- Measured rows: **3 wins / 2 losses / 1 ties / 1 blocked** for Hermes Turbo Agent on this host

## Side-by-side rows

| Row | Hermes 0.14.0 | Hermes Turbo Agent | Winner | Delta | Notes |
| --- | ---: | ---: | --- | --- | --- |
| Cold start (import_model_tools proxy) | 4894.32 ms | 2866.11 ms | Hermes Turbo Agent | 1.71x | Fresh subprocess import of model_tools as a cold-start proxy. |
| JSON dumps short payload | 6.719 us | 9.773 us | Hermes 0.14.0 | 0.69x |  |
| Tool-call parse | 2.735 us | 6.651 us | Hermes 0.14.0 | 0.41x |  |
| Token estimate batch | 453.374 us | 109.353 us | Hermes Turbo Agent | 4.15x | Hermes Turbo uses estimate_messages_tokens; stock uses estimate_messages_tokens_rough. |
| Async 1,000-task scheduler | 167.28 ms | 166.52 ms | Hermes Turbo Agent | 1.00x | Hermes Turbo run requested uvloop; stock stayed on default asyncio. |
