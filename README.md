...
|---|---:|---:|---:|---:|
| `cost_router.CostAwareRouter.decide` (10-call loop) | 18.8 | 47.6 | 11 114.7 | **590.30×** |
| `routing.DeterministicRouter.route` | 1.4 | 1.5 | 186.6 | **136.59×** |
| `uvloop_runner.run_batch` (200 jobs) | 3 300.1 | 3 882.1 | 227 750.8 | **69.01×** |
| `project_mapping.detect_fingerprint` | 2 813.5 | 2 969.7 | 96 959.4 | **34.46×** |
| `tool_replay.replay_if_hit` (warm) | 53.0 | 91.3 | 606.5 | **11.44×** |
| `async_dag.DagExecutor.run` (5 independent nodes) | 5 494.8 | 6 061.7 | 26 013.7 | **4.73×** |
| `tool_replay.tool_call_key` (blake2b) | 4.2 | 7.6 | 4.8 | **1.15×** |
| `receipts.content_hash` (blake2b vs sha256) | 0.8 | 1.2 | 0.9 | **1.12×** |
| `receipts.lookup_receipt` (disk hit) | 41.1 | 77.0 | N/A | net-new |
| `provider_chain.ProviderChain.call` (happy path) | 0.8 | 0.9 | 0.7 | 0.90× ¹ |
| `tracing.span()` context manager | 4.9 | 9.1 | 2.5 | 0.50× ¹ |
